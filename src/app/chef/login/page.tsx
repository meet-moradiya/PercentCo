      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-surface border border-surface-border p-8 transition-colors duration-300">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg text-foreground font-medium">Chef Sign In</h2>
              <p className="text-xs text-muted">Access the kitchen display system</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="chef@percentco.com"
              />
            </div>
            <div>
