...
export default function Location() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-24 md:py-32 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <span className="text-gold text-sm tracking-[0.3em] uppercase">Find Us</span>
          <h2 className="font-(family-name:--font-display) text-4xl md:text-5xl mt-2 mb-4">Location & Contact</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-(family-name:--font-display) text-lg mb-1">Address</h3>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-(family-name:--font-display) text-lg mb-1">Phone</h3>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-(family-name:--font-display) text-lg mb-1">Email</h3>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-(family-name:--font-display) text-lg mb-1">Hours</h3>
            ...
            <div className="p-6 border border-gold/20 bg-gold/5">
              <p className="text-sm text-foreground/60">
                <span className="text-gold font-semibold">Valet Parking</span> — Complimentary valet parking is available for all dinner reservations.
                Simply pull up to our main entrance on Madison Avenue.
              </p>
            </div>
          </div>
        </div>
